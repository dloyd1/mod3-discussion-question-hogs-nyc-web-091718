...
const SHORTRANGE = 1200   // the delay range until non-selected elements begin their animation
const LONGRANGE = 1800    // the delay range until the selected element begins its animation
